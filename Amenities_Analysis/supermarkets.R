...
supermarkets <- st_read("/Users/sugarcane/Downloads/bt4015/SupermarketsGEOJSON.geojson")
...
supermarkets_3414 <- st_transform(supermarkets, 3414)
planning_3414 <- st_transform(planning, 3414)

coords <- st_coordinates(supermarkets_3414)
kde <- kde2d(
  coords[,1],
  coords[,2],
  n = 300,       
