...
facilities <- st_read("/Users/sugarcane/Downloads/bt4015/SportSGSportFacilitiesGEOJSON.geojson")
planning <- st_read("/Users/sugarcane/Downloads/bt4015/MasterPlan2019PlanningAreaBoundaryNoSea.geojson")

facilities <- st_zm(facilities)
planning <- st_zm(planning)

facilities_3414 <- st_transform(facilities, 3414)
planning_3414 <- st_transform(planning, 3414)

coords <- st_coordinates(facilities_3414)
kde <- kde2d(
  coords[,1],
  coords[,2],
  n = 300,      
