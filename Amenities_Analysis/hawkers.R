...
hawkers <- st_read("/Users/sugarcane/Downloads/bt4015/HawkerCentresGEOJSON.geojson")
planning <- st_read("/Users/sugarcane/Downloads/bt4015/MasterPlan2019PlanningAreaBoundaryNoSea.geojson")

hawkers <- st_zm(hawkers)
planning <- st_zm(planning)

hawkers_3414 <- st_transform(hawkers, 3414)
planning_3414 <- st_transform(planning, 3414)

coords <- st_coordinates(hawkers_3414)
kde <- kde2d(
  coords[,1],
  coords[,2],
  n = 300,     
